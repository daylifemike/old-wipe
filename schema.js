...
(function (window) {
    ...
    window.PhotoSwiper.schema = [
        // non-PhotoSwipe settings
        { name : 'selector',            default : '',       value : '',       type : 'string',    label : 'Selector: Base Match',        help : "The selector used to target your image links.  This should be as greedy as possible.  Leave blank for a greedy match of all images that link to other images." },
        { name : 'selectorFilter',      default : '',       value : '',       type : 'string',    label : 'Selector: Exclude Filter',    help : "Filters the Base matches, discarding matching any elements." },
        { name : 'logSelectorMatch',    default : false,    value : false,    type : 'bool',      label : 'Log Selector Match',          help : "This will print a list of matching elements to your browser's javascript console.  This is only useful for testing your Base & Filter selector and should not be left enabled."  },
